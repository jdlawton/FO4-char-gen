...
("Chemist", 1, "Intelligence", 7, 1, "Any chems you take last 50% longer. Far out.", 1),
...
("Gunslinger", 1, "Agility", 1, 1, "Channel the spirit of the old west! Non-automatic pistols do 20% more damage.", 1),
("Gunslinger", 2, "Gunslinger", 1, 7, "Non-automatic pistols now do 40% more damage and have increased range.", 1),
("Gunslinger", 3, "Gunslinger", 2, 15, "Non-automatic pistols now do 60% more damage and range is increased even further.", 1),
("Gunslinger", 4, "Gunslinger", 3, 27, "Non-automatic pistols now do 80% more damage and their attacks can disarm opponents.", 1),
("Gunslinger", 5, "Gunslinger", 4, 42, "Non-automatic pistols now do double damage. Their attacks have a much better chance to disarm opponents, and may even cripple a limb.", 1),
("Commando", 1, "Agility", 2, 1, "Rigorous combat training means automatic weapons do 20% more damage.", 1),
("Commando", 2, "Commando", 1, 11, "Attacks with automatic weapons do 40% more damage with improved hip fire accuracy.", 1),
("Commando", 3, "Commando", 2, 21, "Attacks with automatic weapons do 60% more damage. Hip fire accuracy is improved even more.", 1),
("Commando", 4, "Commando", 3, 35, "Attacks with automatic weapons do 80% more damage and gain a chance to stagger opponents.", 1),
("Commando", 5, "Commando", 4, 49, "Your automatic weapons now do double damage and have a greater chance to stagger opponents.", 1),
("Sneak", 1, "Agility", 3, 1, "Become whisper, become shadow. You are 20% harder to detect while sneaking.", 1),
("Sneak", 2, "Sneak", 1, 5, "You are now 30% harder to detect while sneaking, and no longer trigger floor-based traps.", 1),
("Sneak", 3, "Sneak", 2, 12, "You are now 40% harder to detect while sneaking, and no longer trigger enemy mines.", 1),
("Sneak", 4, "Sneak", 3, 35, "You are now 50% harder to detect while sneaking, and running no longer adversely affects stealth.", 1),
("Sneak", 5, "Sneak", 4, 38, "Engaging stealth causes distant enemies to lose you", 1),
("Mister Sandman", 1, "Agility", 4, 1, "As an agent of death, you can instantly kill a sleeping person. Your silenced weapons do an additional 15% sneak attack damage.", 1),
("Mister Sandman", 2, "Mister Sandman", 1, 17, "Your silenced weapons do an additional 30% sneak attack damage.", 1),
("Mister Sandman", 3, "Mister Sandman", 2, 30, "Your silenced weapons now do 50% more sneak attack damage.", 1),
("Action Boy/Action Girl", 1, "Agility", 5, 1, "There's no time to waste! Action Points regenerate 25% faster.", 1),
("Action Boy/Action Girl", 2, "Action Boy/Action Girl", 1, 18, "Your Action Points now regenerate 50% faster.", 1),
("Action Boy/Action Girl", 3, "Action Boy/Action Girl", 2, 38, "Your Action Points now regenerate 75% faster.", 4),
("Moving Target", 1, "Agility", 6, 1, "They can't hurt what they can't hit! Get +25 Damage Resistance and +25 Energy Resistance when you're sprinting.", 1),
("Moving Target", 2, "Moving Target", 1, 24, "You now get +50 Damage Resistance and +50 Energy Resistance when you're sprinting.", 1),
("Moving Target", 3, "Moving Target", 2, 44, "Sprinting costs 50% fewer Action Points.", 1),
("Ninja", 1, "Agility", 7, 1, "Trained as a shadow warrior, your ranged sneak attacks do 2.5x normal damage and your melee attacks do 4x normal damage.", 1),
("Ninja", 2, "Ninja", 1, 16, "Your ranged sneak attacks do 3x normal damage and your melee sneak attacks do 5x normal damage.", 1),
("Ninja", 3, "Ninja", 2, 33, "Your ranged sneak attacks do 3.5x normal damage and your melee sneak attacks do 10x normal damage.", 1),
("Quick Hands", 1, "Agility", 8, 1, "In combat, there's no time to hesitate. You can reload all guns faster.", 1),
("Quick Hands", 2, "Quick Hands", 1, 28, "Reloading guns costs no Action Points in V.A.T.S.", 1),
("Quick Hands", 3, "Quick Hands", 2, 40, "Quick and efficient. You gain 10 additional Action Points.", 1),
("Blitz", 1, "Agility", 9, 1, "Find the gap and make the tackle! V.A.T.S. melee distance is increased significantly.", 1),
("Blitz", 2, "Blitz", 1, 29, "V.A.T.S. melee distance is increased even more, and the farther the Blitz distance, the greater the damage.", 1),
("Gun Fu", 1, "Agility", 10, 1, "You've learned to apply ancient martial arts to gunplay! Do 25% more damage to your second V.A.T.S. target and beyone.", 1),
("Gun Fu", 2, "Gun Fu", 1, 26, "In V.A.T.S. you do 50% more damage to your third target and beyone.", 1),
("Gun Fu", 3, "Gun Fu", 2, 50, "In V.A.T.S. you instantly do a Critial Hit against your fourth target and beyond.", 1),
("Fortune Finder", 1, "Luck", 1, 1, "You've learned to discover the Wasteland's hidden wealth, and discover more bottle caps in containers.", 1),
("Fortune Finder", 2, "Fortune Finder", 1, 5, "You find even more bottle caps in containers.", 1),
("Fortune Finder", 3, "Fortune Finder", 2, 25, "You find even more bottle caps in containers.", 1),
("Fortune Finder", 4, "Fortune Finder", 3, 40, "You find even more bottle caps in containers, and there is a chance of enemies exploding into a shower of caps when you kill them.", 1),
("Scrounger", 1, "Luck", 2, 1, "You know just how to sccavenge to keep the fight going, and find more ammunition in containers.", 1),
("Scrounger", 2, "Scrounger", 1, 7, "You find even more ammunition in containers.", 1),
("Scrounger", 3, "Scrounger", 2, 24, "You find evne more ammunition in containers.", 1),
("Scrounger", 4, "Scrounger", 3, 37, "There is a chance to gain ammo when firing the last round in your magazine.", 1),
("Bloody Mess", 1, "Luck", 3, 1, "+5% bonus damage means enemies will sometimes explode into a gory red paste. Watch out for flying eyeballs!", 1),
("Bloody Mess", 2, "Bloody Mess", 1, 9, "You now inflict +10% damage in combat.", 1),
("Bloody Mess", 3, "Bloody Mess", 2, 31, "You now inflict +15% damage in combat.", 1),
("Bloody Mess", 4, "Bloody Mess", 3, 47, "When an enemy explodes, nearby enemies may suffer the same fate.", 1),
("Mysterious Stranger", 1, "Luck", 4, 1, "Who is he? Why does he help? Who cares! They Mysterious Stranger will appear occasionally in V.A.T.S. to lend a hand, wiht dealy efficiency.", 1),
("Mysterious Stranger", 2, "Mysterious Stranger", 1, 22, "The Mysterious Stranger appears more often in V.A.T.S.", 1),
("Mysterious Stranger", 3, "Mysterious Stranger", 2, 41, "The Mysterious Stranger appears more often in V.A.T.S. When he kills an opponent, there is a chance your Crital meter gets filled.", 1),
("Mysterious Stranger", 4, "Mysterious Stranger", 3, 49, "The Mysterious Stranger appears more often in V.A.T.S. When he kills an opponent, there is a high chance your Critical meter gets filled.", 7),
("Idiot Savant", 1, "Luck", 5, 1, "You're not stupid! Just...different. Randomly receive 3x XP from any action, and the lower your Intelligence, the greater the chance.", 1),
("Idiot Savant", 2, "Idiot Savant", 1, 11, "You now randomly receive 5x XP from any action. The lower your Intelligence, the greater the chance.", 1),
("Idiot Savant", 3, "Idiot Savant", 2, 34, "Randomly receiving bonus XP from any action may trigger 3x XP for all kills for a short period of time. The lower your Intelligence, the greater the chance.", 1),
("Better Criticals", 1, "Luck", 6, 1, "Advanced training for enhanced combat effectiveness! Criticals do 50% more extra damage.", 1),
("Better Criticals", 2, "Better Criticals", 1, 15, "Your criticals now do twice as much extra damage.", 1),
("Better Criticals", 3, "Better Criticals", 2, 40, "Your criticals now do 2.5x as much extra damage.", 1),
("Critical Banker", 1, "Luck", 7, 1, "You're a patient battlefield tactician, and can save a Critical Hit, to be used in V.A.T.S. when you need it most.", 1),
("Critical Banker", 2, "Critical Banker", 1, 17, "You can now save 2 Critical Hits, to be used in V.A.T.S. when you need the most.", 1),
("Critical Banker", 3, "Critical Banker", 2, 43, "You can now save 3 Critical Hits, to be used in V.A.T.S. when you need them the most. Banking a Critical has a chance to save an additional Critical.", 1),
("Critical Banker", 4, "Critical Banker", 3, 50, "You can now save 4 Critical Hits, to be used in V.A.T.S. when you need them the most.", 4),
("Grim Reaper's Sprint", 1, "Luck", 8, 1, "Death becomes you! Any kill in V.A.T.S. has a 15% chance to restore all Action Points.", 1),
("Grim Reaper's Sprint", 2, "Grim Reaper's Sprint", 1, 19, "Any kill in V.A.T.S. now has a 25% chance to restore all Action Points.", 1),
("Grim Reaper's Sprint", 3, "Grim Reaper's Sprint", 2, 46, "Any kill in V.A.T.S. has a 35% chance to restore all Action Points and refill your Critical meter.", 1),
("Four Leaf Clover", 1, "Luck", 9, 1, "Feeling Lucky? You should! Each hit in V.A.T.S. has a chance of filling your Critial meter.", 1),
("Four Leaf Clover", 2, "Four Leaf Clover", 1, 13, "Each hit in V.A.T.S. now has an even better chance of filling your Critical meter.", 1),
("Four Leaf Clover", 3, "Four Leaf Clover", 2, 32, "Each hit in V.A.T.S. now has a very good chance of filling your Critical meter.", 1),
("Four Leaf Clover", 4, "Four Leaf Clover", 3, 48, "Each hit in V.A.T.S. now has an excellent chance of filling your Critical meter.", 1),
("Ricochet", 1, "Luck", 10, 1, "What goes around comes around! Any enemy's ranged attacks will sometimes ricochet back and instantly kill them. The closer you are to death, the higher the chance.", 1),
("Ricochet", 2, "Ricochet", 1, 29, "There's an increased chance that an enemy's shot will ricochet back and kill them.", 1),
("Ricochet", 3, "Ricochet", 2, 50, "When an enemy's shot ricochets back and kills them, there is a chance your Critical meter gets filled.", 1);
